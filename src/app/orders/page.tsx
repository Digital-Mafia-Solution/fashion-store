...
export default function CustomerOrdersPage() {
  ...
  return (
    <div className="container max-w-4xl py-12 mx-auto px-4 text-foreground">
      ...
      <div className="space-y-6">
        {orders.length === 0 ? (
          ...
          orders.map((order) => (
            <Card key={order.id} className="overflow-hidden bg-card border-border">
                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <Badge className={
                      ...
                      order.status === 'ready' ? 'bg-blue-600' : 'bg-orange-500'
                    }>
                      {order.status}
                    </Badge>
                  </div>
              ...
              <CardContent className="p-6">
                ...
                {order.pickup_location_id && order.locations && (
                  <div className="flex items-start gap-2 mb-6 p-3 bg-blue-50 dark:bg-blue-900/20 text-blue-900 dark:text-blue-200 rounded-md text-sm">
                    ...
                    <div>
                      <span className="font-semibold block">Collection Point:</span>
